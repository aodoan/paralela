...
int main(){
    int size = 4;
    float* heap = malloc(sizeof(float) * size);
    int elements = 0;
    insert(heap, &elements, 1.0);
    insert(heap, &elements, 4.0);
    insert(heap, &elements, 6.0);
    insert(heap, &elements, 2.0);
    insert(heap, &elements, 8.0);
